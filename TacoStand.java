public class TacoStand
{
	...
	public static final int ASADA = 1, POLLO = 2, LENGUA = 3, ULTIMATE = 4;
	...
	public static void printMenu()
	{
		...
		System.out.printf("%2d. %-21s [$%5.2f]%n", TacoStand.ASADA, "Carne Asada (Steak)", 2.5);
		System.out.printf("%2d. %-21s [$%5.2f]%n", TacoStand.POLLO, "Pollo Asado (Chicken)", 1.75);
		System.out.printf("%2d. %-21s [$%5.2f]%n", TacoStand.LENGUA, "Lengua (Beef Tongue)", 3.0);
		System.out.printf("%2d. %-21s [$%5.2f]%n", TacoStand.ULTIMATE, "Ultimate Taco", 18.0);
	...
	*/
	...
	public static boolean orderSupplies(double budget)
	{
		...
		else if(budget <= TacoStand.totalFunds)
		{
		...
		else // rest of possibilities goes here: budget > TacoStand.totalFunds
		{
			return false;
		}
	}
	...
	{
		if(tacoOption == TacoStand.ASADA && numTacos <= TacoStand.numAsada)
		{
			return true;
		}
		else if(tacoOption == TacoStand.POLLO && numTacos <= TacoStand.numPollo)
		{
			return true;
		}
		else if(tacoOption == TacoStand.LENGUA && numTacos <= TacoStand.numLengua)
		{
			return true;
		}
		else if(tacoOption == TacoStand.ULTIMATE && numTacos <= TacoStand.numUltimate)
		{
			return true;
		}
		else
	...
	public static void updateTotalFunds(int tacoOption, int numTacos)
	{
		...
		switch(tacoOption)
		{
			case TacoStand.ASADA:
				cost = 2.5;
				TacoStand.numAsada -= numTacos;
				break;
			case TacoStand.POLLO:
				cost = 1.75;
				TacoStand.numPollo -= numTacos;
				break;
			case TacoStand.LENGUA:
				cost = 3.0;
				TacoStand.numLengua -= numTacos;
				break;
			case TacoStand.ULTIMATE:
				cost = 18.0;
